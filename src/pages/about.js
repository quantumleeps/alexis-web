...
export default () => (
  <Layout location="/about" >
    ...
    <div>
      <a href="https://twitter.com/lexinthecity1?lang=en" target="_blank"><img style={{ width: '30px', height: '30px' }}src={Twitter} /></a>
      <a href="https://www.instagram.com/lexinthecity1/" target="_blank"><img style={{ marginLeft: '25px', width: '30px', height: '30px' }}src={Instagram} /></a>
